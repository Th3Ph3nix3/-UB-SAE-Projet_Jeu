...
public partial class Pistol : Weapons_Data
{
	...
	public override void EffectUpdate()
	{
		...
		holder.GetTree().CurrentScene.AddChild(NewProjectile); // add the projectile to the scene /!\ maybe the enemy targeted is already dead, so godot will display an error.
	}
}
